...
public class SeleniumRobot extends BaseTest {
    ...
    public String pegarValorTexto(WebElement elemento) {
        waitProcessPage();
        esperaElementoFicarVisivel(elemento);
    ...
    public void esperaElementoFicarVisivel(WebElement elemento) {
        waitProcessPage();
    ...
    private void waitProcessPage() {
        WebDriverWait webDriverWait = new WebDriverWait(BaseTest.getWebDriver(), 5);
        webDriverWait.until(waitProcess());
    }

    public void aceitarPopUp() {
        waitProcessPage();
        getWebDriver().switchTo().alert().accept();
    }

    public void recusarPopUp() {
        waitProcessPage();
